...
from keras.layers import Conv1D, Input, GlobalMaxPooling1D, Dense, Lambda, maximum, GaussianNoise, concatenate, BatchNormalization
...
def construct_model(num_kernels=16, kernel_width=20, seq_len=None, dropout_prop=0.0, kernel_initializer=initializers.glorot_uniform(seed=12), optimizer='adam', activation='linear', num_classes=1, l1_reg=0.000001, gaussian_noise = 0.0, spatial_dropout = 0.0):
